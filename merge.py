...
def main():
    ...
    scraper3_games, scraper3_platforms = scrape_gamerpower(num_pages=30, max_workers=3)
    if scraper3_games is None:
        scraper3_games = []
    
    print("\n[2/3] Running scraper1 (Telegram)...")
    scraper1_games = scrape_with_pagination("https://t.me/s/freegames", num_pages=50)
